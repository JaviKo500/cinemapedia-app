...
final upComingMoviesProvider = StateNotifierProvider< MoviesNotifiers, List<Movie> >((ref) {
...
final topRatedMoviesProvider = StateNotifierProvider< MoviesNotifiers, List<Movie> >((ref) {
